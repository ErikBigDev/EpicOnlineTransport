...
namespace EpicTransport {
	...
	public class EosTransport : Transport
	{
		...
		public override bool ServerDisconnect(int connectionId) => ServerActive() && server.Disconnect((ulong)connectionId);
		public override string ServerGetClientAddress(int connectionId) => ServerActive() ? server.ServerGetClientAddress((ulong)connectionId) : string.Empty;
